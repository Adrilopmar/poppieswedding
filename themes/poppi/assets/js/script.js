(function($) {
    ...
    -------------------------------------------*/
    let index_hijos = 0;
    $(".container-reserva-hijos .main-label-autocar").on("click", function(){
        if( $(this).data("autocar") ) {
            $( ".container-form-hijo").slideDown( "slow" );            
        }else{
            $( ".container-form-hijo").slideUp( "slow" );
            $( ".button-hijo").removeClass( "margin-top-hijo" );
        }
    })
    $(".button-hijo").on("click", function(e){
        e.preventDefault();
        ...
        $(".formulario-inscripcion-hijos").append(`
            <div class="inscripcion-hijo col-md-12 justify-content-between flex-wrap" style="display:none">
                ...
                <div class="form-hijo-eliminar">
                    <button class="button-hijo-eliminar">Eliminar</button>
                </div>
            </div>
            `);
            index_hijos ++;
            $(".inscripcion-hijo").slideDown( "slow" );
            $(".button-hijo-eliminar").on("click", function(e){
                e.preventDefault();
                const element = $(this).closest(".inscripcion-hijo");
                element.slideUp();
                setTimeout(()=>{
                    element.remove();
                },500)
    ...
    if ($('.wpo-site-header .navigation').length) {
        ...
        // $('#saveTheDate').html('Save the date').css({"font-size":"32px"}); 
        // $('.original #dateSave').remove(); 
...
/*------------------------------------------
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2025/05/03 18:00:00', function(event) {
            ...
            + '<div class="box"><div><div class="time">%S</div> <span>Segs</span> </div></div>'));
        });
    }
    /*------------------------------------------
        = COUNTDOWN CLOCK2
...
//     }
    ...
    ==========================================================================*/
        $(window).on('load', function() {
            ...
            smoothScrolling($(".smooth-link"), $(".wpo-site-header .navigation").innerHeight());
        });
